...
$FileUrl = "https://github.com/arkypita/LaserGRBL/releases/download/v$UpstreamVersion/install.exe"
...
(Get-Content .\src\lasergrbl.template.nuspec.xml) -replace '%%VERSION%%', $UpstreamVersion | Out-File -Encoding utf8 ".\target\lasergrbl.nuspec"
